...
/**
 * Сторінка команди розробників гри D.R.I.L.L.
 *
 * Відображає картки всіх учасників команди 6.7Zip із зазначенням
 * їх імен, ролей у проєкті та короткого опису внеску.
 *
 * @returns Розмітка сторінки з сіткою карток {@link TeamMemberCard}
 */
export default function Team() {
  /**
   * Масив даних про членів команди.
   *
   * @property name - Повне ім'я учасника
   * @property role - Роль учасника у проєкті
   * @property desc - Короткий опис внеску учасника
   */
  const teamMembers = [
